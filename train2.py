...
from view_neural_data2 import get_neural_data

print("Running")
images, labels = get_mnist()
print("Data Acquired")

w_i_h1, b_i_h1, w_h1_h2, b_h1_h2, w_h2_o, b_h2_o = get_neural_data()
'''w_i_h1 = np.random.uniform(-0.5, 0.5, (200, 784))
b_i_h1 = np.zeros((200, 1))
w_h1_h2 = np.random.uniform(-0.5, 0.5, (100, 200))
b_h1_h2 = np.zeros((100, 1))
w_h2_o = np.random.uniform(-0.5, 0.5, (10, 100))
...
for epoch in range(epochs):
    ...
    for idx in indices:
        ...
        # back propagation : output -> hidden2
        delta_o = o - l
...
with open("data/neural_data_real.dat", "wb") as f:
    pickle.dump(w_i_h1, f)
    pickle.dump(b_i_h1, f)
    pickle.dump(w_h1_h2, f)
    pickle.dump(b_h1_h2, f)
    pickle.dump(w_h2_o, f)
    pickle.dump(b_h2_o, f)
    input()
